...
const P2pInnerNav = () => {
  return (
    <div className="w-11/12 mx-auto block md:flex flex-row gap-7 items-center text-[#ffffff] opacity-70 py-4 md:p-4 mt-8 bg-blend-overlay">
      <div className="flex gap-6 md:gap-4 md:inline-flex">
